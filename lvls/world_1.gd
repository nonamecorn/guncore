...
func spawn():
	while roomcount != 0:
		...
		match connector_info[1]:
			0: corr_inst = corr_north_obj.instantiate()
			1: corr_inst = corr_west_obj.instantiate()
			2: corr_inst = corr_east_obj.instantiate()
			3: corr_inst = corr_south_obj.instantiate()
